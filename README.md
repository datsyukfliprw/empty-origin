...
**Current-version notice (September 19, 2026):** The canonical twenty-five [chapter files](book1/chapters) total **77,610 words**. [WORKING_DRAFT.md](book1/WORKING_DRAFT.md) has been rebuilt directly from those chapter files and is synchronized through Chapter Twenty-Five. Historical reviews retain the counts from their own passes.

Continue from **[book1/WORKING_DRAFT.md](book1/WORKING_DRAFT.md)**, currently through Chapter Twenty-Five. Individual chapters are in [book1/chapters](book1/chapters).
...
The latest continuation now runs through **Chapter Twenty-Five**. Chapters Twenty–Twenty-Two total 7,977 words: bounded boundary testing, confirmation of Fallow Reach as the local receiving station, the completed drainage repair, employment/relationship decisions, and the first safely failed spanning test. The working manuscript is **77,610 words across twenty-five chapters**. The [continuation review](book1/CONTINUATION_REVIEW_16_19.md) remains the historical audit for Chapters Sixteen–Nineteen. The earlier [developmental review](book1/DEVELOPMENTAL_REVIEW.md) remains the record of revisions through Fifteen. This is an unfinished first book.
