...
Book One now runs through **Chapter Thirty-Two** and has a completed first-draft ending. Chapters Twenty–Twenty-Two total 7,977 words: bounded boundary testing, confirmation of Fallow Reach as the local receiving station, the completed drainage repair, employment/relationship decisions, and the first safely failed spanning test. The working manuscript is **101,176 words across thirty-two chapters**. The [continuation review](book1/CONTINUATION_REVIEW_16_19.md) remains the historical audit for Chapters Sixteen–Nineteen. The earlier [developmental review](book1/DEVELOPMENTAL_REVIEW.md) remains the record of revisions through Fifteen. This is a complete first-draft Book One manuscript; revision and publication work remain.
