...
Pell remains responsible for drainage and the people relying on it. Dain remains the technical authority on the works, not all aspects of transit. Vey openly rejected the concession in Seventeen and paid three pieces toward preparation; any later pressure must build on that position. He can help at a cost later, but another extracted admission cannot stand in for that choice.
...
Follow the binding direction in [project notes](PROJECT_NOTES.md#binding-mayatolliver-relationship-direction) and the [series bible](../SERIES_BIBLE.md): Maya is powerful and capable; Tolliver knows and desires it; he can overpower her anyway; she chooses to let him; his obsession is undoing her composure, not making her small. These are future scene obligations, not completed beats.

- Give Maya a consequential demonstration of strength and leadership that Tolliver witnesses and respects. His attraction should become more specific as she grows stronger.
- Earn trust through his costly honesty and concrete support for her independence. Preserve the consequences of his earlier withholding.
- Establish his physical advantage in a credible context, with her abilities functioning and neither injury nor helplessness supplying the romantic premise. Respect current injuries and recovery.
- Develop a mutually wanted encounter in which Maya deliberately lets him take control. Show that he wants her response and chosen surrender, and that she can stop or change the encounter. If it reaches sex, keep the encounter on page with the same explicit, embodied continuity used for Maya and Sella.
- Carry the intimacy into an aftermath where her authority, ambition, and capacity to disagree remain intact. Resolve relationship expectations with the people involved; preserve Sella's significance and independent choices.

Do not force these beats into the next chapter or count a rescue, a hard kiss, or jealousy as sufficient delivery. Let the progression and repaired trust make the payoff convincing within the remaining Book One arc.
...
The private mystery solution has a working layout in `RESCUE_MECHANICS.md`; its timing hypothesis still requires bounded on-page tests. Reveal what Maya needs to act. A complex mechanism explained after the climax would not make the climax fair.
