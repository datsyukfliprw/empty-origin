...
**Current ARC-repair status, September 19, 2026:** Book One is complete through Chapter Thirty-Two at **100,303 whitespace-counted words**. The focused clean-reader repair pass is applied. See [repair report](ARC_REPAIR_COMPLETION_2026-09-19.md) and [wage/calendar ledger](ARC_WAGE_CHRONOLOGY_2026-09-19.md). The house mender owns medical examination and clearance; Mara remains keeper, sister and enforcer of those orders. Brace requires a physical load path. Day 18 and expedition Days 19–20 are already paid; Days 21–33 produce a 104-bit retained-work settlement on Day 34. Maya plans to leave Rook four days later for a two-day cart journey and an early Greyward visit. Earlier checkpoint headings below are historical, not the current endpoint.
...
## Manuscript state — through Chapter Twenty-Two
...
- `STORY_OVERVIEW.md`: chronological prose synopsis through Chapter Twenty-Two.
...
- Final compiled manuscript length: **100,303 words** across thirty-two chapters.
