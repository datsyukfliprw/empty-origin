...
**Current manuscript status, September 20, 2026:** Book One is complete through Chapter Thirty-Two at **96,731 whitespace-counted words** after the September 20 prose-restoration and compression passes. [WORKING_DRAFT.md](WORKING_DRAFT.md) is synchronized to the canonical chapter files. The September 19 [ARC repair report](ARC_REPAIR_COMPLETION_2026-09-19.md) and [wage/calendar ledger](ARC_WAGE_CHRONOLOGY_2026-09-19.md) remain historical records of the version they audited. The house mender owns medical examination and clearance; Mara remains keeper, sister and enforcer of those orders. Brace requires a physical load path. Day 18 and expedition Days 19–20 are already paid; Days 21–33 produce a 104-bit retained-work settlement on Day 34. Maya plans to leave Rook four days later for a two-day cart journey and an early Greyward visit. Earlier checkpoint headings below are historical, not the current endpoint.
...
- Final compiled manuscript length after the September 20 prose revisions: **96,731 words** across thirty-two chapters.
