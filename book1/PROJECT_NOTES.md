...
**Active working revision, September 24, 2026:** 32 chapters, **97,048 whitespace-counted words**. The accepted alternate opening remains active; available cold-review fixes and continuity repairs are recorded in [REVISION_2026-09-24.md](REVISION_2026-09-24.md). The requested alternate-beginning review files are still missing. This is an unfrozen working revision. September 20 and later checkpoint text below describes prior states.


**Current manuscript status, September 20, 2026:** Book One is complete through Chapter Thirty-Two. The latest compiled [WORKING_DRAFT.md](WORKING_DRAFT.md) contains **96,693 whitespace-counted words** after the focused post–cold-read revisions, technical/copyedit pass, and subsequent rebuild. The chapter files remain canonical. **Repository synchronization, technical/copyedit, and final proof are complete. The manuscript is frozen as the September 20, 2026 beta/ARC master; the next manuscript step is the beta/ARC round.** README, project notes, chapter ledger, story overview, title references, and historical-review labels have been reconciled to the current manuscript. See [PUBLICATION_ROADMAP.md](PUBLICATION_ROADMAP.md) and [MANUSCRIPT_FREEZE.md](MANUSCRIPT_FREEZE.md). The September 19 [ARC repair report](ARC_REPAIR_COMPLETION_2026-09-19.md) and [wage/calendar ledger](ARC_WAGE_CHRONOLOGY_2026-09-19.md) remain historical records of the versions they audited. The house mender owns medical examination and clearance; Mara remains keeper, sister and enforcer of those orders. Brace requires a physical load path. Day 18 and expedition Days 19–20 are already paid; Days 21–33 produce a 104-bit retained-work settlement on Day 34. Maya plans to leave Rook four days later for a two-day cart journey and an early Greyward visit. Earlier checkpoint headings below are historical, not the current endpoint.

## Author instructions — current authority
...
**Working target: 105,000 words, with a flexible 95,000–115,000-word revision range.**

At an illustrative 250–300 words per printed page, 105,000 words is about **350–420 pages** before front/back matter. This is a layout-dependent estimate, not a fixed production page count or a guarantee of commercial success. Use the story's completed arc and revision needs to decide final length. Chapters follow scene needs; there is no per-chapter quota.

The editorial rationale and the source supporting the genre range are in [EDITORIAL_DIRECTION.md](EDITORIAL_DIRECTION.md). Future plot proposals are provisional; the written chapter files govern canon. The author instructions above, including the ongoing series and permanent settlement, are binding.

## Historical manuscript-state checkpoint — through Chapter Twenty-Two
...
- `chapters/`: canonical chapter text. Edit these first.
- `WORKING_DRAFT.md`: complete reading copy, generated by joining chapters in order. Rebuild after chapter edits.
- `STORY_OVERVIEW.md`: chronological prose synopsis through Chapter Thirty-Two.
- `CHAPTER_LEDGER.md`: continuity facts, uncertainties, resources, and immediate endpoint.
...
- `CONTINUATION_REVIEW_16_19.md`: historical continuation audit through Chapter Nineteen.
- `RESCUE_MECHANICS.md`: writer's physical model and ability limits; unwritten mechanism explanations remain provisional.

The two original export directories and ZIPs remain unchanged as snapshots. Chapter Six came from `Nora_Whitcomb_MD_Files_Partial/Pasted markdown.md`, despite the older aggregate draft ending at Chapter Five. The newly supplied [writing system](../writing-system/README.md) now provides the consolidated prose specification, development state, anti-patterns, examples, and voice-development handoff. Route Five, Compass, and Zippy remain unavailable; no execution or compliance with those resources is claimed.

The supplied Nora Story Ledger workflow was used to backfill Chapters One–Six in order and record the new continuation after its audit. Refresh existing sections when a chapter changes; do not append duplicates.

## Applying the writing system

Use [PROSE.md](../writing-system/PROSE.md), [DEVELOPMENT.md](../writing-system/DEVELOPMENT.md), and [ANTI_PATTERNS.md](../writing-system/ANTI_PATTERNS.md) for prose decisions. Only POV/distance, sentence rhythm, and internal monologue are developed and locked. Examples calibrate principles and supply no book canon. Preserve Maya's first-person present voice and character-specific knowledge.
...
## Historical handoff — Chapter Twenty-Two checkpoint

Chapter Twenty-Two ends on **local Day 17** after the first bounded spanning test fails safely. Maya is **LV. 3, progress 15/18, reserve 5/5, Warder**, public label Traveler, origin still blank. Her left ankle has been reassessed for flat indoor walking and limited stairs but remains sore; no field work or shield practice has been cleared. Her repaired green shield remains hers. She has not crossed the transit boundary.

The separate drainage route is now operating at the planned draw after Rusk's crew lifted and rebuilt the root-supported throat. Bera has visible field recovery but crop losses remain. Rusk completed the two-day lift, was paid under the six-piece deposit plus Vey's wool-backed balance, then departed. Rook purchased her worn four-to-one lower block for **20 bits** through a pooled payment; the block now belongs to Rook and Harra repaired its missing hook keeper.

Maya's original Day 13–15 preparation agreement was extended for Days 16–17 and then one additional Day 18. Her rate remains eight bits/day with food, room, property protections, right to stop/change assignments and the written return-cart term preserved. Sella and Tolliver are likewise hired through Day 18 at twelve and ten bits/day. Maya's exact personal cash after these new wages has not been explicitly counted on page after the Day 16 payment, so do not invent a purse total without reconciling receipts.

Boundary work now establishes that time of day is not a usable schedule. Multiple observations correlate widening with a rising-pressure condition and contraction with a lower falling condition at the old works, but exact thresholds and delays remain uncertain. A stationary wax tablet was severed during contraction, confirming the visible edge moves across objects. Independent measurements and the Fallow Reach plan establish Iven's rooms as the abandoned local receiving station with imported Earth fittings. This is not Earth and Maya has emotionally accepted that specific route home is gone.

Chapter Twenty-Two opened the lower service stair on Rook's side under explicit abort rules. The first narrow ash test frame rested briefly on both Rook and Iven-side stone supports without a through-line. During withdrawal its overlong far pin caught on the sloped receiving landing; contraction severed the frame. All people remained clear, the block/anchors were retained, and Mara's prewritten rule barred a same-day second attempt. The failure identifies a fixable known weak point: receiving landing pitch plus a pin that projected too far. Next work should inspect the far half, load-test the near anchor independently, build a shorter-pin/adjustable-foot frame and only then decide whether another spanning attempt is justified.
...
- Maya's left ankle is materially worse after the delve. The house mender orders three days with no stairs, rough ground, shield work, Stepguard, or powered loading; this restriction remains active at chapter end.
...
## Current endpoint update — Chapters 27–29

- Canonical manuscript now runs through Chapter Twenty-Nine.
- Chapter Twenty-Seven spans Maya's three-day recovery window while Harra, Oret, Dain and the others build and dry-test the full rescue frame. Maya remains under the house mender’s no-stairs/no-rough-ground/no-powered-loading restriction until the final reassessment, then receives limited-loading clearance for the rescue day. The full design uses a short far pin, bounded two-finger spring travel, an iron-backed near wedge and a release-before-unload sequence.
- Sella's accepted eastbound route-guard/scout job departs after midday on the fourth day. Maya refuses to make Sella sacrifice the job to an uncertain rescue schedule; Sella retains independent agency and the relationship remains real but unresolved.
- Captain Rusk returns with three crew and a district salvage preservation notice. The notice does not grant human custody or automatic lower-chamber access, but it can preserve disputed recovered inner iron pending hearing. Pell/Vey negotiate a bounded witness arrangement. Maya accepts that potentially important iron/Earth-related material may have to remain on the receiving side in order to prioritize Iven's extraction.
- Chapter Twenty-Eight contains the first human rescue attempt. The original spring-foot frame seats successfully, but during contraction both the far spring travel and rigid near clamp create a bind; releasing the near clamp one notch frees the far latch and enables a safe abort. Iven remains alive on the far side. The failure reveals that the next design must decouple both ends rather than merely make the far support compliant.
- The revised rescue frame uses a captured floating near sleeve with one finger of travel plus the two-finger far spring shoe, along with a sacrificial board joint. Six dry cycles after the redesign stay within the vibration limits.
- Chapter Twenty-Nine completes the rescue. During the second attempt, an independent pressure-driven activation of the old isolation mechanism consumes both travel limits. Maya orders the sacrificial far board joint released after Iven passes it, Braces through forearm contact with the anchor shoe and feet on its stone bed long enough for Harra to release the near sleeve, and then deliberately releases her Brace rather than preserving the structure. Sella and Tolliver hold Iven, not the frame. Iven reaches Rook's side alive.
- Maya gives up immediate recovery of disputed iron and possible Earth-related answers rather than gamble Iven's life or hand Rusk custody leverage. Rusk's salvage claim survives for later adjudication, but her attempted leverage does not block the human rescue.
- Maya and Sella explicitly say they love each other before the second rescue attempt. Sella still intends to leave with the eastbound team after midday and explicitly recognizes Maya's unresolved/falling attachment to Tolliver.
...
- Chapter Thirty gives the post-rescue aftermath to Sella rather than using her departure as a bridge directly into Tolliver. Maya remains under the house mender’s renewed ankle restriction immediately after the rescue and cannot simply walk off the injury.
...
- The house mender keeps Maya off the ankle for six more days after the rescue, then gradually clears flat walking, light shield work, stairs, and finally Stepguard. The roof memory occurs on the seventh evening after explicit ladder clearance; Tolliver’s question comes on the eighth night, and their encounter stays on the ninth night. This recovery time is necessary before the Tolliver encounter so injury/helplessness is not its premise.
...
- Final compiled manuscript length after the September 20 prose revisions: **96,693 words** across thirty-two chapters.
- Day 18 and the two expedition days (19–20) are already paid. Continued employment is reconciled at eight bits/day for thirteen retained workdays, Days 21–33, including medically restricted consultation. She receives 104 bits / 13 pieces. Day 34 is settlement/release, with no new assignment.
- Maya converts the unused return-cart value into a four-week Rook room arrangement, pays 28 bits in cash after that credit, and secures a locked storage chest with explicit property protections while traveling. This gives her a concrete place to return to without entering Rook service.
